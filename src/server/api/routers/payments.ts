...
const checkoutTranslations: Record<"en" | "pl", LemonsqueezyProductOptions> = {
  en: {
    ...
    name: "DyneTap Menu",
    receipt_button_text: "Go to DyneTap",
    receipt_link_url: "https://www.dynetap.com/dashboard",
    receipt_thank_you_note: "Thank you for your purchase!",
    redirect_url: "https://www.dynetap.com/dashboard",
  },
  pl: {
    description: "Wyświetlaj menu QR Twoim klientom.",
    name: "DyneTap Menu",
    receipt_button_text: "Przejdź do DyneTap",
    receipt_link_url: "https://www.dynetap.com/dashboard",
