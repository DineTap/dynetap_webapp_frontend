...
const messages: Resources["common"] = {
  ...
  dashboard: {
    title: "Restaurants",
    headingText: "Create and manage your restaurants.",
    createMenu: "Create Restaurant",
    noMenusCreated: "No Restaurants Created",
    noMenusCreatedDescription: "You haven't created any restaurants yet",
  },
  dashboardSidenav: {
    menus: "Restaurants",
    billing: "Billing",
  ...
  globalMetadata: {
    ...
    openGraph: {
      ...
      image: "https://www.dynetap.com/og-image.png",
      siteName: "DyneTap - create your online menu",
      locale: "pl_PL",
    },
    twitter: {
      title: "Online Menu for Your Restaurant",
  ...
  billing: {
    ...
    sadToSeeYouGo:
      "We are sad to see you go :(, if you have any feedback that can help us improve, please write to us at: support@dynetap.com",
    continue: "Continue",
  ...
  notifications: {
    ...
    subscriptionCancelledDescription:
      "Feel free to give us feedback on how can we improve! support@dynetap.com",
