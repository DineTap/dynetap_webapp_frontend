const messages = {
  ...
  globalMetadata: {
    ...
    openGraph: {
      ...
      siteName: "DyneTap - stwórz swoje menu online",
      locale: "pl_PL",
    },
    twitter: {
      title: "Menu Online dla Twojej Restauracji",
  ...
  billing: {
    ...
    sadToSeeYouGo:
      "Smutek nas ogarnia, że odchodzisz :(, jeśli masz jakieś uwagi, które mogą pomóc nam w rozwoju, napisz do nas na adres: support@dynetap.com",
    continue: "Kontynuuj",
  ...
  notifications: {
    ...
    subscriptionCancelledDescription:
      "Daj nam znać, co moglibyśmy zrobić lepiej na adres: support@dynetap.com",
